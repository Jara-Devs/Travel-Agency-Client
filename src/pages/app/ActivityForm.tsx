...
import { HotelFormType, TouristPlace, TouristActivity, TouristActivityFormType } from '../../types/services';
...
const TouristActivityForm: FC<TouristActivityFormProps> = ({ onOk, onCancel, values, open }) => {
