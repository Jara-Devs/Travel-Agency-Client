...
import FlightOfferForm from "./FlightOfferForm";
...
const AgencyFlightOffer = () => {
    ...
    const load = async (
        ...
        const response = await get({
            ...
            expand: {
                flight: {
                    select: ["company", "origin", "destination"],
                },
            },
                        ...
                        <TableEntities
                            ...
                            columns={[
                                ...
                                },
                                {
                                    title: "Flight",
                                    key: "flight",
                                    render: (v: FlightOfferType) => <>{v.flight.company + ": " + v.flight.origin.name + "-" + v.flight.destination.name}</>,
                                },
                                {
                                    title: "Availability",
                                    key: "availability",
                                ...
                                },
                                {
                                    title: "Initial Date",
                                    key: "startDate",
                                    render: (v: FlightOfferType) => <>{v.startDate}</>,
                                },
                                {
                                    title: "Final Date",
                                    key: "endDate",
                                    render: (v: FlightOfferType) => <>{v.flightId}</>,
                                },
                                {
                                    title: "Facilities",
                                    key: "facilities",
